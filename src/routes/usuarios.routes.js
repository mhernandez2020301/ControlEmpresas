...
api.put('/tunear:idEmpresa', md_autenticacion.Auth, usuariosControlador.EditarEmpresa);
api.delete('/eliminarEmpresa:idEmpresa', md_autenticacion.Auth, usuariosControlador.EliminarEmpresa);
api.put('/tuneo:idEmpresa', md_autenticacion.Auth, usuariosControlador.EditarUsuario);
